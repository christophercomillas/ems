                ...
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        ?>
                                    ...
                                    <div class="trwrap" data-id="<?php echo $value['trans_id']; ?>">                                
                                        <div class="form-group">
                                            <label class="col-md-3">Transaction #: <?php echo $value['trans_num']; ?></label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="input-group input-sm date">
                                                    ...
                                                    <input type="text" data-dateid="<?php echo $value['trans_id']; ?>" class="form-control pull-right datepickers datep<?php echo $value['trans_id']; ?>" id="datepickers" name="date_c" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <button class="btn btnchdt" type="button" data-datebt="<?php echo $value['trans_id']; ?>"><i class="fa fa-fw fa-check"></i></button>
                                            </div>
                                        </div>   
                                        <div class="form-group">
